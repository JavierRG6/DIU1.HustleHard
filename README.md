...
----
<img width="630" height="484" alt="AlejandroUser" src="https://github.com/user-attachments/assets/7c02acf1-01ff-447d-8499-fe9d6815a2b4" />
...
Pantalla de exploración del catálogo gastronómico, organizada por biomas y categorías. Incluye sistema de filtrado, buscador y visualización de platos con nombre, descripción y precio.<br>
...
El proceso de desarrollo de Anime Ramen ha sido nuestra primera experiencia completa aplicando metodología UX de forma estructurada, desde la investigación inicial hasta las pruebas de evaluación con usuarios reales. En términos generales, valoramos el resultado de forma positiva: la puntuación SUS obtenida de 75,5 (categoría *Good*, percentil 74) confirma que el diseño es percibido como usable y satisfactorio por la mayoría de perfiles, superando a nuestro caso de comparación y situándose por encima del 74% de sistemas evaluados con esta escala a nivel global.

Los aspectos que consideramos más logrados son la jerarquía visual de la landing page, donde el CTA principal ("Reservar Mesa") funciona correctamente y atrae atención de forma natural según el Eye Tracking, y la coherencia identitaria del proyecto, cuya propuesta temática Ghibli fue bien recibida por los usuarios técnicos. El flujo de reserva en 4 pasos también fue valorado positivamente en términos de claridad estructural.

Sin embargo, el informe de evaluación externo ha puesto de manifiesto áreas de mejora reales que no habíamos detectado con suficiente claridad durante el desarrollo. La más relevante es el problema de contraste en las tarjetas de bioma y el footer, que no cumple el criterio WCAG 1.4.3 (ratio mínimo 4.5:1) y afecta directamente a usuarios con baja visión. La baja puntuación de P08 (77 años, SUS 52.5) también nos recuerda que el diseño, aunque intuitivo para perfiles técnicos, tiene fricciones importantes para usuarios de mayor edad o con menor competencia digital, algo que deberíamos haber atacado más en la fase de prototipado. Igualmente, la sección "¿Qué nos hace únicos?" es prácticamente ignorada visualmente, lo que indica que el contenido diferenciador del restaurante no está llegando al usuario en el momento adecuado del flujo.

En cuanto al proceso metodológico, la experiencia con GazeMapping, el cuestionario SUS y el A/B Testing nos ha resultado muy valiosa: hemos aprendido que las decisiones de diseño que parecen obvias durante el desarrollo no siempre son percibidas igual por el usuario final, y que herramientas como el eye tracking revelan comportamientos que ningún formulario de satisfacción detectaría. Como principales áreas de mejora para una siguiente iteración identificamos: corregir el contraste en los componentes de bioma, añadir el landmark `<main>` en el HTML, simplificar el texto descriptivo para perfiles no técnicos, y reposicionar o rediseñar la sección de propuesta de valor para que no quede enterrada en el flujo de escaneo visual.
